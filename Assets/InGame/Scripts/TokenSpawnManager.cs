...
public class TokenSpawnManager : MonoBehaviour
{
    ...
    // public void SpawnPlayerTokens(List<CharacterData> player1Characters, List<CharacterData> player2Characters)
    // {
    ...
    // private void SpawnTokensForPlayer(List<CharacterData> characters, RectTransform spawnArea, List<GameObject> tokenList, bool isPlayer1)
    // {
